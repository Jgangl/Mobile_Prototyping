...
public class SwipeDetector : MonoBehaviour
{
    ...
    private void Awake() {
        if (Instance == null)
            ...
            Debug.Log("Swipe Detector instance already exists, deleting object: " + this.gameObject);
            Destroy(this);
        }
...
/*
    void checkSwipe() {
        ...
        if (verticalMove() > SWIPE_LENGTH_THRESHOLD && verticalMove() > horizontalValMove()) {
            //Debug.Log("Vertical");
        ...
        else if (horizontalValMove() > SWIPE_LENGTH_THRESHOLD && horizontalValMove() > verticalMove()) {
